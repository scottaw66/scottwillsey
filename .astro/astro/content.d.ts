...
"sessions-script-command.md": {
	id: "sessions-script-command.md";
...
"superduper-initial.md": {
	id: "superduper-initial.md";
  slug: "superduper-initial";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"superduper-invisible.md": {
	id: "superduper-invisible.md";
...
"weekly-reads-mail.md": {
	id: "weekly-reads-mail.md";
